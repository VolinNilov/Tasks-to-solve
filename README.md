...
Найти среднее арифметическое целых чисел, записанных в файле task_2.txt в столбик (файл можно скачать выше). Количество чисел неизвестно. Результат записать в файл task_2_output.txt.

**Входные данные**
Целые числа записаны в файле task_2.txt в столбик, по одному в строке. Ввод заканчивается тогда, когда заканчиваются данные в файле.

**Выходные данные**
Программа должна вывести в файл task_2_output.txt среднее арифметическое всех чисел в файле.
