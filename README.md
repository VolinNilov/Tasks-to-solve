...
Создайте два вектора `vec1` и `vec2`, внесите в них следующие данные: в vec1: "Hello world, my name is /ваше имя/" и в vec2: "Hello world, my name is /ваше имя/ and i love C++". Убедитесь что `vec1` и `vec2` равны с 0 по 23 символы, используя следующую конструкцию:
